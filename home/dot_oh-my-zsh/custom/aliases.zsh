...
alias temporal-cli-local="docker run --rm -it -v /home/zeben/dev/kuflow/src/kuflow/etc/docker/volumes/temporal.io/etc/temporal/config/tls/worker:/etc/certs/ --entrypoint tctl --network host --env-file /home/zeben/dev/kuflow/conf/kuflow-temporal-dev-environment.env temporalio/admin-tools:1.20.0"
